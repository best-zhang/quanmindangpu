...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h3 class="page-header">客户按月数据详情</h3>
            <div class="row">
                <div class="col-sm-1 col-md-1"><a href="../finance" class="lineheigh30">返回</a></div>
                <div class="col-sm-3 col-md-3 pad0 padleft30">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8 pad0">
                            <label class="text-center lineheigh30"
                                   id="labmonth"><?php echo $month; ?></label>
                        </div>
                    </div>
                </div>
                <div class="col-sm-3 col-md-3 pad0 padleft30">
                    <div class="row">
                        ...
                        <div class="col-sm-8 col-md-8 pad0">
                            <label class="text-center lineheigh30" cid="<?php echo $customerid; ?>"
                                   id="labCustomer"><?php echo $customer; ?></label>
                        </div>
                    </div>
                </div>
...
<script src="../../styles/js/billdetail.js"></script>
