...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
        ...
        <div class="pull-right">
            ...
            <span> <a href="_userlogin.html">登录</a> </span>
        </div>
    </div>
</nav>
    ...
    <div class="container padding-30">
        <div class="row">
            <div class="col-lg-5 col-md-6 col-sm-6 col-xs-6">
                <div class="img-pro-main" style="background-image: url(assets/img/bg2.jpg);"></div>
                <div class="font-120">地址：反对撒艰苦地方哈市警方撒</div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 padding-left-20">
                <div class="font-200 padding-bottom-10">长安街当铺</div>
                <div class="font-130 padding-bottom-10">dasfadgfdajkfkjdalfjlsaawejljcsahdfiuewhjkdsahfkjasdfjahjk</div>
                <div class="progress">
                ...
                <div class="font-130 padding-bottom-10">目标：￥<span>3,000,000</span></div>
                <div class="font-130 padding-bottom-10">起投：￥<span>30,000</span></div>
                <div class="font-130 padding-bottom-10">截止时间：￥<span>30,000</span></div>
                <div class="padding-top-10"><span class="label label-info">筹备中</span></div>
            </div>
        </div>
        <div class="row margin-top-20">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                <div class="well bg-blue padding-left-50">
                    ...
                    <div class="font-120 padding-top-10 margin-top-10">电话号码：<span>2316542312</span></div>
                    <div class="font-120 padding-top-5">微信：<span>2316542312</span></div>
                    <div class="font-120 padding-top-5">QQ：<span>2316542312</span></div>
                </div>
            </div>
        </div>
    </div>
