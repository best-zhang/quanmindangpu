...
<body>
	<div
		class="login-container margin-30 margin-top-50 animated fadeInDown">
		<div class="loginbox bg-white pull-right">
			...
			<div class="loginbox-submit margin-top-30">
				<input id="btnLogin" type="button" class="btn btn-primary btn-block"
					onclick="login();" value="登 录">
			</div>
		</div>
	</div>
	<div class="navbar-fixed-bottom loginbox-copyright padding-bottom-10">Copyright
		© www.qmdp168.com, All Rights Reserved.</div>
